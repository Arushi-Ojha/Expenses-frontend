...
const { toggleTheme } = useTheme();
  ...
  const handleSort = async () => {
    try {
      const res = await axios.get(`/api/expenses/${username}/sort?order=${sortOrder}`);
      setExpenses(res.data.expenses);
  ...
  const handleFilter = async () => {
    ...
    try {
      const res = await axios.get(`/api/expenses/${username}/filter`, {
        params: filterDates
      });
  ...
  const handleDelete = async (expenseId) => {
    try {
      await axios.delete(`/api/expenses/${username}/${expenseId}`);
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      await axios.put(`/api/expenses/${username}/${id}`, {
        amount,
        category,
        description,
        date,
